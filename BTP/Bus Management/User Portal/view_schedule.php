...
//code for date and time selection
$min = new DateTime();
$max = new DateTime();
$max->modify("+6 days");
?>
...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Blog Section ======= -->
                <
 <br><br>
<form style="margin-left: 14em;" name="myform" action="view_schedule.php" method="post">
...
<button type="submit" style="margin-left: 20px;background: #f44336;color: #fff;padding: 4px 20px;border-radius: 8px;">Select</button>
                 ...
                 <!-- <label style="margin-left: 120px;">Enter Day</label> &nbsp; &nbsp;

                  <select style="width: 1000px;">
                  <option value="volvo">Weekdays</option>
