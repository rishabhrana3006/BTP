<?php
    ...
    $cap = $_POST['phno'];
    $driver = $_POST['lic'];
    $sql = "INSERT INTO `btp`.`driver` VALUES ('$bus_id', '$avail', '$cap', '$driver');";
  ...
  <main id="main">
    ...
    <section class="contact" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <form action="" method="post" role="form" style="width: 1300px;">
              ...
              <br>
              <div class="form-group mt-3">
                <input type="number" class="form-control" name="bus_no" id="email" placeholder="Bus No" required>
              </div>
          
            <br>
              <div class="form-group mt-3">
                <input type="number" class="form-control" name="phno" id="subject" placeholder="Phone Number" required>
              </div>
              <br>
              <div class="form-group mt-3">
                  <input type="text" class="form-control" name="lic" id="email" placeholder="Licence Number" required>
                </div>
              <br>
              ...
              <?php
              if($insert==true){
                echo "<h2 style='color: #006400; font-size: 18px; margin: 0%;'> Driver Added Successfully ! </h2>";
              ...
              <div class="text-center"><button type="submit" style="margin-left: 0px; border: 2px solid grey; padding: 4px 4px 4px; color: #4fa6d5; background:#fff">Add Driver</button></div>
            </form>
          </div>
