<?php
    ...
    $cap = $_POST['cap'];
    $driver = $_POST['driver'];
    $sql = "INSERT INTO `btp`.`bus` (`Bus_Id`, `Availability`, `Capacity`, `Driver`) VALUES ('$bus_id', '$avail', '$cap', '$driver');";
  ...
  <h3 align=center>Add Bus</h2>
    ...
    <section class="contact" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <form action="add_bus.php" method="post" role="form" style="width: 1300px;">
            <br>
                <div class="form-group mt-3">
                  <input type="text" class="form-control" name="bus_id"  placeholder="Bus No" required>
                </div>
              ...
              <br>
              <div class="form-group mt-3">
                <input type="number" class="form-control" name="cap" placeholder="Capacity" required>
              </div>
              <br>
              <div class="form-group mt-3">
              ...
              <br>
                <?php
              if($insert==true){
                echo "<h2 style='color: #006400; font-size: 18px; margin: 0%;'> Bus Added Successfully ! </h2>";
              ...
              <div class="text-center"><button type="submit" style="margin-left: 0px; border: 2px solid grey; padding: 4px 4px 4px; color: #4fa6d5; background:#fff">Add Bus</button></div>
