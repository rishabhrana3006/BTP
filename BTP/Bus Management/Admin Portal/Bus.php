        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry" style="width: 1300px;">
             ...
             <div class="text-center"><a type="submit" style="margin-left: 400px; border: 2px solid grey; padding: 2px 2px 2px;" href="add_bus.html">Add Bus</a>
             </div>
